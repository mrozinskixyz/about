...
.tiType('i am interested in anything that has to do with code.')
.tiPause(300)
.tiBreak()
.tiPause(1000)
.tiSettings({speed: 100})

.tiType('but my specialty is java.')
.tiPause(1800)
.tiBreak()
.tiPause(1000)
.tiSettings({speed: 100})

.tiType('feel free to contact me at any time;')
.tiPause(1800)
.tiBreak()
.tiPause(1000)
.tiSettings({speed: 100})

.tiType('my email is frederic[at]mrozinski.xyz ')
.tiPause(1800)
.tiPause(1000)
.tiSettings({speed: 100})